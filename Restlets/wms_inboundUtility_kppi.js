...
define(['N/search','N/runtime','N/record','N/config','N/format','./big_open','./wms_translator_kppi','N/url', './wms_utility_kppi','N/task','N/query'],
	...
	function updateOpenTask(objOpentaskDetails)
	{
		...
		openTaskRecord.setValue({fieldId :'custrecord_wmsse_drnumber',value: drNumber}); // data input
 ...
 function convertToJsonObj(result,resultsArray,columnsObj)
	...
	function mergeKitComponentsDetails(transactionLineDetailsResult,kitComponentsDetails){
		...
		function getItemNameForMatrix(kitComponentsDetails,componentsLength)
		{
			...
			function _createOrUpdateOpentask(openTaskId,quantity,objOpentaskDetails,warehouseLocationId,lotName,drNumber){
