			...
			function inventoryInvTransfer(invtransferObj) {
				...
				if (towhLocation == 665) {
					...
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol614',
						value: parseInt(rejectType1) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol75',
						value: parseInt(rejectType2) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol76',
						value: parseInt(rejectType3) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol615',
						value: parseInt(rejectType4) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol103',
						value: parseInt(rejectType5) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol616',
						value: parseInt(rejectType6) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol617',
						value: parseInt(rejectType7) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol107',
						value: parseInt(rejectType8) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol140',
						value: parseInt(rejectType9) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol108',
						value: parseInt(rejectType10) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol109',
						value: parseInt(rejectType11) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol618',
						value: parseInt(rejectType12) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol78',
						value: parseInt(rejectType13) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol111',
						value: parseInt(rejectType14) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol81',
						value: parseInt(rejectType15) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol619',
						value: parseInt(rejectType16) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol112',
						value: parseInt(rejectType17) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol83',
						value: parseInt(rejectType18) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol620',
						value: parseInt(rejectType19) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol639',
						value: parseInt(rejectType20) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol622',
						value: parseInt(rejectType21) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol623',
						value: parseInt(rejectType22) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol624',
						value: parseInt(rejectType23) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol640',
						value: parseInt(rejectType24) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol626',
						value: parseInt(rejectType25) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol627',
						value: parseInt(rejectType26) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol628',
						value: parseInt(rejectType27) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol86',
						value: parseInt(rejectType28) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol88',
						value: parseInt(rejectType29) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol91',
						value: parseInt(rejectType30) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol629',
						value: parseInt(rejectType31) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol120',
						value: parseInt(rejectType32) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol92',
						value: parseInt(rejectType33) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol630',
						value: parseInt(rejectType34) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol93',
						value: parseInt(rejectType35) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol631',
						value: parseInt(rejectType36) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol121',
						value: parseInt(rejectType37) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol632',
						value: parseInt(rejectType38) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol633',
						value: parseInt(rejectType39) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol122',
						value: parseInt(rejectType40) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol94',
						value: parseInt(rejectType41) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol96',
						value: parseInt(rejectType42) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol124',
						value: parseInt(rejectType43) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol132',
						value: parseInt(rejectType44) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol99',
						value: parseInt(rejectType45) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol134',
						value: parseInt(rejectType46) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol135',
						value: parseInt(rejectType47) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol634', 
						value: parseInt(rejectType48) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol635',
						value: parseInt(rejectType49) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol636',
						value: parseInt(rejectType50) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol637',
						value: parseInt(rejectType51) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol638',
						value: parseInt(rejectType52) || 0
					});
					invTransfer.setCurrentSublistValue({
						sublistId: 'inventory',
						fieldId: 'custcol601',
