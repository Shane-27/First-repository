...
define(['N/log'], function(log) {
    function getDefaultValue(warehouseLocation) {
        ...
        } else if (warehouseLocation === 'KPVN AMATA : AMATA TRADING - RM WH') {
            defaultValue = 'A-Trading JO Staging';
        } else if (warehouseLocation === 'KPVN AMATA : AMATA BRANCH - RM WH') {
            defaultValue = 'A-Branch JO Staging';
        } else if (warehouseLocation === 'KPVN AMATA : AMATA EPE - RM WH') {
